...
hold on;
l(2) = plot(p(1), xGraphYe5, yGraphYe5, 's','LineWidth',1,'MarkerSize',10, 'MarkerEdgeColor',[r g b], 'DisplayName',legendName(9) );
r = 255/255;
g = 0/255;
b = 0/255; 
l(3) = plot(p(1), xGraph1, yGraph1, 'Linewidth', 3, 'Color', [r g b], 'DisplayName',legendName(1) );
...
hold on;
l(5) = plot(p(2), xGraphYe6, yGraphYe6, 's','LineWidth',1,'MarkerSize',10, 'MarkerEdgeColor',[r g b], 'DisplayName',legendName(10) );
r = 255/255;
g = 0/255;
b = 0/255; 
l(6) = plot(p(2), xGraph2, yGraph2, 'Linewidth', 3, 'Color', [r g b], 'DisplayName',legendName(2) );
...
g = 0/255;
b = 0/255; 
l(7) = plot(p(3), xGraphYe7, yGraphYe7, 's','LineWidth',1,'MarkerSize',10, 'MarkerEdgeColor',[r g b], 'DisplayName',legendName(11) );
hold on;
r = 255/255;
g = 0/255;
b = 0/255; 
l(8) = plot(p(3), xGraph3, yGraph3, 'Linewidth', 3, 'Color', [r g b], 'DisplayName',legendName(3) );
...
hold on;
l(10) = plot(p(4), xGraphYe8, yGraphYe8, 's','LineWidth',1,'MarkerSize',10, 'MarkerEdgeColor',[r g b], 'DisplayName',legendName(12) );
r = 255/255;
g = 0/255;
b = 0/255; 
l(11) = plot(p(4), xGraph4, yGraph4, 'Linewidth', 3, 'Color', [r g b], 'DisplayName',legendName(4) );
